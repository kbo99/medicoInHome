...
import com.medico.home.admon.parametro.dao.IParametroDAO;
 ...
 */
@Service 
public class ParametroAdmService implements IParametroAdmService {
	
	 Logger logger = LoggerFactory.getLogger(ParametroAdmService.class);
